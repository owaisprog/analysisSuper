    ...
    <div className="max-w-[1360px] w-[90%] mx-auto">
      ...
      <div className="flex relative rounded-[50px] text-white translate-y-[-80px] mx-auto w-[30%] overflow-hidden focus-within:text-[#1A73E8]">
        <input
          ...
          className="focus:text-[#222] border-2  border-[#1A73E8] rounded-[50px] transition-all focus:bg-white outline-none bg-[#1A73E8] w-full placeholder:text-white text-xs font-bold px-5 py-3"
          value={searchTerm}
